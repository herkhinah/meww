...
foreign import ccall safe "__c_run" run :: IO (())
foreign import ccall safe "__c_printNum" printNum :: FunPtr(IO (CInt)) -> IO (())
foreign import ccall safe "__c_createWindow" createWindow :: CString -> IO (())
